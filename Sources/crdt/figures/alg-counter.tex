...
\KwOut{$\mathit{true}$ if{f} there exists read-from and happens-before relations $\rf$ and $\hb$ such that $m\subseteq \hb$, and $\tup{\hist,\rf,\hb}$ satisfies the counter axioms.}
\BlankLine
