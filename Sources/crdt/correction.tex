...
The p-time algorithms for admissibility problem for replicated counter and sets, flags provided in subsection \label{sec:counters} and \label{sec:ptime:sets} respectively are incorrect.
