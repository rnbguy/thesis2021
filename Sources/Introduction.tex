...
\node[draw,circle,fill=black,scale=0.3,label=above:{\texttt{add(b)}}](r11) at (.5, 3) {};
\node[draw,circle,fill=black,scale=0.3,label=above:{\texttt{add(a)}}](r12) at (2, 3) {};
\node[draw,circle,fill=black,scale=0.3,label=above:{\texttt{remove(b)}}](r13) at (5, 3) {};
\node[draw,circle,fill=black,scale=0.3,label=above:{\texttt{read()=\{a,b\}}}] at (9, 3) {};
...
\node[label=below:{\texttt{\{b\}}}] at (1, 3) {};
\node[label=below:{\texttt{\{a,b\}}}] at (2.5, 3) {};
\node[label=below:{\texttt{\{a,b\}}}] at (4, 3) {};
\node[label=below:{\texttt{\{a\}}}] at (5.5, 3) {};
\node[label=below:{\texttt{\{a,b\}}}] at (7, 3) {};
\node[label=below:{\texttt{\{a,b\}}}] at (8.5, 3) {};

\draw (r11) edge[out=-90,in=90] (3.5, 0);
\draw (r12) edge[out=-90,in=90] (6.5, 0);
\draw (r13) edge[out=-90,in=90] (8, 0);

\draw (r21) edge[out=90,in=-90] (3.5, 3);
\draw (r22) edge[out=90,in=-90] (6.5, 3);
\draw (r23) edge[out=90,in=-90] (8, 3);
    ...
    \begin{subfigure}{.45\textwidth}
        \resizebox{\textwidth}{!}{
         \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
          ...
          \node (t1) at (0, 0) {\begin{tabular}{l}
            \texttt{Payment(k):} \\
            \texttt{  x = read\_balance()} \\
            \texttt{  ...} \\ 
            \texttt{  update\_balance(x - k)} \end{tabular}};
            \node (t2) at (5, 0) {\begin{tabular}{l}
              \texttt{Payment(k):} \\
              \texttt{  x = read\_balance()} \\
              \texttt{  ...} \\ 
              \texttt{  update\_balance(x - k)} \end{tabular}};
        ...
        \resizebox{\textwidth}{!}{
         \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
          ...
          \node[draw, rounded corners=2mm] (t1) at (0, 0) {\begin{tabular}{l}
            ...
            \texttt{  ...} \\ 
            \texttt{  update\_balance(x - k)} \end{tabular}};
            \node[draw, rounded corners=2mm] (t2) at (6, 0) {\begin{tabular}{l}
              \texttt{Payment(k):} \\
              \texttt{  x = read\_balance()} \\
              \texttt{  ...} \\ 
              \texttt{  update\_balance(x - k) // error} \end{tabular}};
