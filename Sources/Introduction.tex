...
\node[draw, rounded corners=2mm] (r11) at (0, 0) {\begin{tabular}{l} \texttt{remove(x)} \end{tabular}};
\node[draw, rounded corners=2mm] (r21) at (0, -1) {\begin{tabular}{l} \texttt{add(x)} \end{tabular}};
\node[draw, rounded corners=2mm] (r31) at (0, -2) {\begin{tabular}{l} \texttt{remove(x)} \end{tabular}};

\node[draw=black!0] (r12) at (3, 0) {};
\node[draw=black!0] (r22) at (3, -1) {};
\node[draw=black!0] (r32) at (3, -2) {};

\node[draw, rounded corners=2mm] (r13) at (6, 0) {\begin{tabular}{l} \texttt{contain(x) = False} \end{tabular}};
\node[draw, rounded corners=2mm] (r23) at (6, -1) {\begin{tabular}{l} \texttt{contain(x) = True} \end{tabular}};
\node[draw, rounded corners=2mm] (r33) at (6, -2) {\begin{tabular}{l} \texttt{contain(x) = True} \end{tabular}};

\path (r11) edge node {} (r13);
\path (r21) edge node {} (r23);
\path (r31) edge node {} (r33);

\path(r11) edge node {} (r32);
\path (r21) edge node {} (r32);
\path (r31) edge node {} (r12);
\end{tikzpicture}  
% }
\caption{OR-Set}
