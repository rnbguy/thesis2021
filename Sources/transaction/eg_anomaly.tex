  ...
  \begin{subfigure}{0.22\textwidth}
   ...
   \scalebox{0.5}{
    \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=.6cm,
     ...
     \node[draw, rounded corners=2mm, right = of alice1] (alice2) {R(Bob): $\bot$, R(Alice): J3};
     \node[draw, rounded corners=2mm, label=left:{Bob}, below = of alice1] (bob1) {W(Bob): J3};
     \node[draw, rounded corners=2mm, below = of alice2] (bob2) {R(Alice): $\bot$, R(Bob): J3};
