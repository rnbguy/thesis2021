...
%there were recent efforts spanning static analyses~\cite{clotho, burcu-netys}, dynamic analyses~\cite{acidrain, maryam}, and testing~\cite{jepsen}.
%
%Static analyses~\cite{clotho,burcu-netys} encode transactions, database consistency specification, and application invariant (sometimes) etc., in verification logic and use SMT solvers to prove that logical formula.
...
%
%
%Dynamic analyses~\cite{acidrain,maryam} work on the abstract models built from the actual execution trace.
