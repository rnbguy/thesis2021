...
%cart~\cite{sivaramakrishnan2015declarative} and Twitter~\cite{twissandra}, and
%also a concurrent stack data-structure \cite{cavNagarMJ20}.
...
\vspace{-2mm}
\paragraph{Shopping Cart \cite{sivaramakrishnan2015declarative}}
...
\vspace{-2mm}
\paragraph{Treiber Stack \cite{cavNagarMJ20}}
...
algorithm was ported to operate on a kv-store in prior work \cite{cavNagarMJ20}
