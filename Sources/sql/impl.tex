...
%(1)~a set of microbenchmarks containing shopping cart~\cite{sivaramakrishnan2015declarative}, Twitter~\cite{twissandra}, stack~\cite{DBLP:conf/cav/NagarMJ20} and courseware~\cite{DBLP:conf/esop/NairP020} applications that are representative of real-world services running on Key-Value stores,  
